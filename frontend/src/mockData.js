...
export const canoBondProducts = [
  {
    id: 1,
    name: 'Tile Adhesive',
    description: 'High-performance polymer-modified adhesive for all types of tiles',
    image: 'https://images.unsplash.com/photo-1703868669362-562283170216?crop=entropy&cs=srgb&fm=jpg&q=85',
    features: ['Strong bonding', 'Water resistant', 'Suitable for all tiles']
  },
  {
    id: 2,
    name: 'Epoxy Grout',
    description: 'Premium stain-resistant grout for joint filling',
    image: 'https://images.unsplash.com/photo-1629608564457-5d74829a9e14?crop=entropy&cs=srgb&fm=jpg&q=85',
    features: ['Stain resistant', 'Chemical resistant', 'Color variety']
  },
  {
    id: 3,
    name: 'Tile Cleaner',
    description: 'Professional-grade tile and grout cleaning solution',
    image: 'https://images.unsplash.com/photo-1637241612956-b7309005288b?crop=entropy&cs=srgb&fm=jpg&q=85',
    features: ['Deep cleaning', 'Safe formula', 'Quick action']
  },
  {
    id: 4,
    name: 'Hardener',
    description: 'Industrial concrete hardener for enhanced durability',
    image: 'https://images.pexels.com/photos/11700775/pexels-photo-11700775.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    features: ['Increases strength', 'Dust-proof finish', 'Long-lasting']
  }
];
