...
const ProductsShowcase = () => {
  ...
  const getBrandProducts = (brandSlug) => {
    return products.filter(p => p.brands?.slug === brandSlug);
  };
  ...
  const productSections = [
    {
      ...
      products: getBrandProducts('canobond')
    },
    {
      brand: 'Blackberry',
      slug: 'blackberry',
      ...
      products: getBrandProducts('blackberry')
    },
    {
      brand: 'Quro Tuff',
      slug: 'furniture', // Mapping Quro Tuff UI to furniture slug in DB
      color: '#A68A7A',
      gradient: 'from-[#A68A7A] to-[#8B7E8B]',
      products: getBrandProducts('furniture')
    }
  ];
