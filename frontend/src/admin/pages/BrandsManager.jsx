...
const BrandsManager = () => {
  ...
  const handleUpdate = async (brandId, updates) => {
    setSaving(brandId);
    try {
      await brandService.updateBrand(brandId, updates);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => handleFieldChange(brand.id, 'logo_url', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                />
                {brand.logo_url && (
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => handleFieldChange(brand.id, 'banner_image_url', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
