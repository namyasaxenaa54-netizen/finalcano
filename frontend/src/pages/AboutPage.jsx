      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-24 h-24 mb-4 mx-auto bg-white rounded-2xl p-4 shadow-md flex items-center justify-center">
                <span className="text-5xl">🪑</span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Quro Tuff</h3>
              <p className="text-gray-600 mb-4">Luxury Living Solutions</p>
